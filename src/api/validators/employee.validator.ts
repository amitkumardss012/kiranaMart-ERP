...
const employeeValidator = z.object({
  ...
  twitterLink: z.string().trim().url("Invalid Twitter URL").optional(),
  faceBookLink: z.string().trim().url("Invalid Facebook URL").optional(),
  instagramLink: z.string().trim().url("Invalid Instagram URL").optional(),
